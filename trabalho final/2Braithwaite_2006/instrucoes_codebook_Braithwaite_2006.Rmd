...
data_repbraith06 <- set_label(data_repbraith06, label = c(
  ...
  "log_radius_area: Logaritmo da área coberta pelo raio geográfico da disputa.",
  ...
  "water: Indicador binário de se a disputa ocorre em áreas marítimas.",
  "logdurat: Logaritmo da duração da disputa.",
  "cwpceyrs: Anos desde o último conflito entre os mesmos países.",
  "host_mt : Indicador binário de se o país anfitrião possui recursos naturais.",
  "host_for: Indicador binário de se o país anfitrião possui cobertura florestal.",
  "host_resource: Indicador binário de se o país anfitrião possui recursos naturais.",
